...
; genEndFunction
	iret
;	./src/stm8s_it.c: 89: INTERRUPT_HANDLER(AWU_IRQHandler, 1)
; genLabel
;	-----------------------------------------
...
; genEndFunction
	iret
;	./src/stm8s_it.c: 101: INTERRUPT_HANDLER(CLK_IRQHandler, 2)
; genLabel
;	-----------------------------------------
...
; genEndFunction
	iret
;	./src/stm8s_it.c: 113: INTERRUPT_HANDLER(EXTI_PORTA_IRQHandler, 3)
; genLabel
;	-----------------------------------------
...
; genEndFunction
	iret
;	./src/stm8s_it.c: 125: INTERRUPT_HANDLER(EXTI_PORTB_IRQHandler, 4)
; genLabel
;	-----------------------------------------
...
; genEndFunction
	iret
;	./src/stm8s_it.c: 137: INTERRUPT_HANDLER(EXTI_PORTC_IRQHandler, 5)
; genLabel
;	-----------------------------------------
...
; genEndFunction
	iret
;	./src/stm8s_it.c: 149: INTERRUPT_HANDLER(EXTI_PORTD_IRQHandler, 6)
; genLabel
;	-----------------------------------------
...
; genEndFunction
	iret
;	./src/stm8s_it.c: 161: INTERRUPT_HANDLER(EXTI_PORTE_IRQHandler, 7)
; genLabel
;	-----------------------------------------
...
; genEndFunction
	iret
;	./src/stm8s_it.c: 187: INTERRUPT_HANDLER(CAN_RX_IRQHandler, 8)
; genLabel
;	-----------------------------------------
...
; genEndFunction
	iret
;	./src/stm8s_it.c: 199: INTERRUPT_HANDLER(CAN_TX_IRQHandler, 9)
; genLabel
;	-----------------------------------------
...
; genEndFunction
	iret
;	./src/stm8s_it.c: 212: INTERRUPT_HANDLER(SPI_IRQHandler, 10)
; genLabel
;	-----------------------------------------
...
; genEndFunction
	iret
;	./src/stm8s_it.c: 224: INTERRUPT_HANDLER(TIM1_UPD_OVF_TRG_BRK_IRQHandler, 11)
; genLabel
;	-----------------------------------------
...
; genEndFunction
	iret
;	./src/stm8s_it.c: 236: INTERRUPT_HANDLER(TIM1_CAP_COM_IRQHandler, 12)
; genLabel
;	-----------------------------------------
...
; genEndFunction
	iret
;	./src/stm8s_it.c: 273: INTERRUPT_HANDLER(TIM2_UPD_OVF_BRK_IRQHandler, 13)
; genLabel
;	-----------------------------------------
...
;	Reset bit 6 of reg CC. Hardware bug workaround.
	div	x, a
;	./src/stm8s_it.c: 275: TIM2_ClearFlag(TIM2_FLAG_UPDATE);
; genSend
	clrw	x
	incw	x
; genCall
	call	_TIM2_ClearFlag
;	./src/stm8s_it.c: 276: svujcas++;
; genPlus
	ldw	x, _svujcas+2
	addw	x, #0x0001
	ldw	y, _svujcas+0
